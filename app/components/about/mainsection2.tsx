  ...
  return (
    <div className="max-w-6xl text-lg mx-auto px-8 md:px-12 pb-16 space-y-8 py-10 md:py-24">
      ...
      <p className="leading-8">
        ...
        special focus on Costa Rica and India. Recognizing the
        interconnectedness of all beings, she has utilized her platform and
        resources to make a positive impact in these communities.
      </p>

      <p className="leading-8">
        From supporting education and healthcare initiatives to fostering
        environmental conservation and sustainable living practices, Adi
        Shakti&apos;s contributions have helped improve the lives of many.
      </p>
      ...
      <div className="grid space-y-3 md:space-y-0 grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="space-y-3">
          ...
          <div>
            ...
            <p className="mt-3">
              Supporting education and healthcare initiatives in Costa Rica
              communities.
            </p>
          </div>
        </div>
        <div className="space-y-3">
          ...
          <div>
            ...
            <p className="mt-3">
              Fostering environmental conservation and sustainable living
              practices.
            </p>
          </div>
        </div>
        <div className="space-y-3">
          ...
          <div>
            ...
            <p className="mt-3">
              Creating a more compassionate and harmonious world through
      ...
      <h1 className="text-3xl md:text-5xl playfair tracking-tight py-10">
        Her work serves as a testament to her commitment to creating a more
